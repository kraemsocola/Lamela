<%-- 
    Document   : profile
    Created on : Oct 25, 2022, 9:41:43 AM
    Author     : hp
--%>
                        ...
                        <div class="cur-lang-acc-dropdown">
                            <ul>    
                                <c:if test="${sessionScope.acc != null}">                                   
                                    ...
                                    <li><a href="changepassword.jsp">Update My Account</a></li>
                                    </c:if>
                                ...
                                <div class="login-form-container">
                                    <div class="login-form">
                                        <form action="register" method="get">
                                            ...
                                            Fullname
                                            <input type="text" value="${user.fullname}" readonly name="user" placeholder="Username">
                                            Phone_number
                                            <input name="phone" value="${user.phone_number}" readonly placeholder="Phone Number" type="text">
                                            Address
                                            <input name="address" value="${user.address}" readonly placeholder="Address" type="text">
                                            Email
                                            <input name="email" value="${user.email}" readonly placeholder="Email" type="email">
                                            Password
                                            <input type="text" value="${user.password}" readonly name="pass" placeholder="Password">                                           
